                        ...
                        <div className="md:w-1/2 flex flex-col justify-between">
                          <div>
                            ...
                            <div className="space-y-6 py-6 mt-6 border-y-4 border-dashed border-gray-100">
                              <StatDisplay
                                label="Cuteness"
                                value={selectedChar.attributes.cuteness}
                                icon={Star}
                                color="text-yellow-500"
                              />
                              <StatDisplay
                                label="Confidence"
                                value={selectedChar.attributes.confidence}
                                icon={Heart}
                                color="text-pink-500"
                              />
                              <StatDisplay
                                label="Tili Factor"
                                value={selectedChar.attributes.tiliFactor}
                                icon={TrendingUp}
                  ...
                  <div className="bg-white border-4 border-black rounded-3xl p-6 shadow-hard flex flex-col flex-grow">
                    <div className="flex items-center justify-between mb-6">
                      <h3
                        ...
                        style={{
                          textShadow: "1px 1px 0px #fff, 3px 3px 0px #000",
                        }}
                      >
                        Squad Archive
                      </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      ...
                      {Array.from({
                        length: Math.max(
                          0,
                          ITEMS_PER_PAGE - displayedCharacters.length,
                        ),
                      }).map((_, i) => (
                        <div
                          key={`empty-${i}`}
                          className="aspect-square rounded-2xl border-4 border-dashed border-gray-100 bg-gray-50/50"
                        />
                      ))}
                    </div>
