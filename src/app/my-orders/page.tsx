...
import { Home, LoaderCircle, ShieldAlert, Package, Truck, CheckCircle, Wallet, ClipboardList } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <header className="bg-white border-4 border-black rounded-full p-3 px-6 flex flex-col md:flex-row justify-between items-center shadow-hard gap-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-headline text-3xl tracking-tight text-black uppercase">My Orders</h1>
          </div>
