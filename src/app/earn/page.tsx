              ...
              <div className="toy-card rounded-[2.5rem] p-8 relative overflow-hidden group border-2 border-indigo-50">
                ...
                <div className="relative z-10">
                  ...
                  <div className="bg-gradient-to-b from-indigo-500 to-purple-600 rounded-3xl p-6 mb-8 shadow-inner relative overflow-hidden h-64 flex items-center justify-center">
                    <Image src="/images/earn/biringan.png" alt="Biringan Conquest" width={500} height={200} className="object-contain transform-gpu hover:scale-105 transition-transform duration-300 tiny-blur" />
              ...
              <div className="toy-card rounded-[2.5rem] p-8 relative overflow-hidden group border-2 border-green-50">
                ...
                <div className="relative z-10">
                  ...
                  <div className="bg-gradient-to-b from-green-400 to-emerald-600 rounded-3xl p-6 mb-8 shadow-inner relative overflow-hidden h-64 flex items-center justify-center">
                    <Image src="/images/earn/kapogianFarm.png" alt="Kapogian Farm" width={500} height={200} className="object-contain transform-gpu hover:scale-105 transition-transform duration-300 tiny-blur" />
                    <div className="absolute top-4 right-[-18px] transform rotate-12 pointer-events-none">
        ...
        <section id="story" className="py-24 bg-white px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {[
                { num: "1", title: "Unbox", icon: "solar:box-minimalistic-bold-duotone", color: "blue", desc: "Order your vinyl toy. It comes with a unique NFC chip embedded in the foot." },
                { num: "2", title: "Scan", icon: "solar:smartphone-2-bold-duotone", color: "purple", desc: "Tap your phone to the toy to claim your Digital Twin NFT instantly." },
                { num: "3", title: "Play", icon: "solar:gamepad-bold-duotone", color: "pink", desc: "Use your character in-game. Stats improve as you hold the physical toy." },
              ].map(({ num, title, icon, color, desc }) => (
                <div key={num} className="bg-white p-8 rounded-[2rem] shadow-xl border-2 border-slate-50 relative z-10 flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
                  <div className={`w-20 h-20 bg-${color}-100 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                    <iconify-icon icon={icon} className={`text-${color}-500 text-4xl`}></iconify-icon>
                  </div>
                  <h3 className="text-2xl font-black text-slate-800 mb-2">{num}. {title}</h3>
