                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div className="toy-card rounded-[2.5rem] p-8 relative overflow-hidden group border-2 border-indigo-50">
                                <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                                    <iconify-icon icon="solar:swords-bold" width="120"></iconify-icon>
                                </div>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="bg-gradient-to-b from-indigo-500 to-purple-600 rounded-3xl p-6 mb-8 shadow-inner relative overflow-hidden h-64 flex items-center justify-center">
                                       <Image src="https://media.discordapp.net/attachments/1473960076665553039/1473962239324065893/image.png?ex=69981dce&is=6996cc4e&hm=aadca3017195cd62bb4779ddf09291121fb9bb43b356ad5e22392476ac119e49&=&format=webp&quality=lossless" alt="Biringan Conquest" width={300} height={200} className="object-contain" />
                            ...
                            <div className="toy-card rounded-[2.5rem] p-8 relative overflow-hidden group border-2 border-green-50">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-slate-500 font-semibold mb-8">Grow crops, raise pets, and earn tokens.</p>
                                    ...
                                    <div className="bg-gradient-to-b from-green-400 to-emerald-600 rounded-3xl p-6 mb-8 shadow-inner relative overflow-hidden h-64 flex items-center justify-center">
                                       <Image src="https://media.discordapp.net/attachments/1473960076665553039/1473962239324065893/image.png?ex=69981dce&is=6996cc4e&hm=aadca3017195cd62bb4779ddf09291121fb9bb43b356ad5e22392476ac119e49&=&format=webp&quality=lossless" alt="Kapogian Farm" width={300} height={200} className="object-contain" />
                                    </div>

                                    {/* Pill Info */}
                                    <div className="flex gap-2 mb-8 flex-wrap">
                                        <div className="bg-green-50 px-3 py-2 rounded-xl text-green-700 font-bold text-xs flex items-center gap-1">
                                            <iconify-icon icon="solar:clock-circle-bold"></iconify-icon> 24h Harvest
                                        </div>
                                        <div className="bg-yellow-50 px-3 py-2 rounded-xl text-yellow-700 font-bold text-xs flex items-center gap-1">
                                            <iconify-icon icon="solar:star-circle-bold"></iconify-icon> Rare Seeds
                                        </div>
                                    </div>
                    ...
                    <div className="max-w-5xl mx-auto px-4 relative z-10 flex flex-col md:flex-row items-center gap-16">
                            ...
                            <div className="relative w-64 h-64 group">
                                ...
                                <div className="w-full h-full bg-gradient-to-tr from-yellow-500 via-yellow-300 to-yellow-600 rounded-full shadow-2xl flex items-center justify-center border-[12px] border-yellow-200 animate-float">
                                    <div className="w-48 h-48 border-4 border-yellow-600/20 rounded-full flex items-center justify-center relative overflow-hidden">
                                        ...
                                        <span className="text-6xl font-black text-yellow-800 tracking-tighter drop-shadow-md">$POGI</span>
                                    </div>
                                </div>
                                {/* Floating sparkles around coin */}
                                <iconify-icon icon="solar:star-bold" className="absolute top-0 right-0 text-yellow-500 text-3xl animate-bounce"></iconify-icon>
                                <iconify-icon icon="solar:star-bold" className="absolute bottom-10 left-0 text-yellow-500 text-2xl animate-pulse"></iconify-icon>
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-1/2 text-center md:text-left">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                ...
                                <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col items-center md:items-start">
                                    <iconify-icon icon="solar:gamepad-charge-bold" className="text-cyan-400 text-2xl mb-2"></iconify-icon>
                        ...
                        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-[2rem] shadow-xl border-2 border-slate-50 relative z-10 flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
                                <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                    <iconify-icon icon="solar:box-minimalistic-bold-duotone" className="text-blue-500 text-4xl"></iconify-icon>
                                </div>
                                <h3 className="text-2xl font-black text-slate-800 mb-2">1. Unbox</h3>
                                <p className="text-slate-500 font-semibold text-sm">Order your vinyl toy. It comes with a unique NFC chip embedded in the foot.</p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-[2rem] shadow-xl border-2 border-slate-50 relative z-10 flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
                                <div className="w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                    <iconify-icon icon="solar:smartphone-2-bold-duotone" className="text-purple-500 text-4xl"></iconify-icon>
                                </div>
                                <h3 className="text-2xl font-black text-slate-800 mb-2">2. Scan</h3>
                                <p className="text-slate-500 font-semibold text-sm">Tap your phone to the toy to claim your Digital Twin NFT instantly.</p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-[2rem] shadow-xl border-2 border-slate-50 relative z-10 flex flex-col items-center text-center group hover:-translate-y-2 transition-transform duration-300">
                                <div className="w-20 h-20 bg-pink-100 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                    <iconify-icon icon="solar:gamepad-bold-duotone" className="text-pink-500 text-4xl"></iconify-icon>
                                </div>
                                <h3 className="text-2xl font-black text-slate-800 mb-2">3. Play</h3>
                                <p className="text-slate-500 font-semibold text-sm">Use your character in-game. Stats improve as you hold the physical toy.</p>
                            </div>
                        </div>
                    </div>
                </section>
