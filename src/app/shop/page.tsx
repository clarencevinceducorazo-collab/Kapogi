        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="p-5 bg-white flex-grow flex flex-col items-center">
                <span className="bg-slate-50 text-slate-500 text-xs font-extrabold px-3 py-1 rounded-full w-fit capitalize">
                  {product.type}
                </span>
                <h3 className="font-headline text-2xl text-slate-800 mt-2 tracking-tight text-center leading-none uppercase">
                  {product.name}
                </h3>
                <div className="flex items-center justify-between mt-auto w-full pt-4">
