          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="space-y-4 text-slate-800 leading-relaxed">
                ...
                <p>
                  ...
                  <strong>Biringan City</strong> and the sustainable agriculture
                  of <strong>Kapogian Farm</strong>, all unified under a single
            ...
            >
              ...
              <p className="mb-6 text-slate-800 leading-relaxed">
                The <strong>Kapogian Spirit NFT</strong> is the heartbeat of the
                ecosystem. It is more than a digital asset; it is a dynamic
                digital idol that serves as your primary avatar and{" "}
                <strong>"Proof of Pogi"</strong> across all project dimensions.
              </p>
            ...
            >
              ...
              <p className="mb-6 text-slate-200 leading-relaxed">
                ...
                Philippines, this
                <strong> Souls-like side-scroller</strong> introduces permanent
                narrative stakes to the blockchain.
              </p>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-yellow-400 pl-6">
                  ...
                  <p className="text-sm text-slate-300">
                    ...
                    human "Light" (talent and confidence) to power their eternal
                    city.
                  </p>
                </div>
            ...
            >
              ...
              <p className="mb-6 text-slate-800 leading-relaxed">
                ...
                ownership with real-world agriculture, allowing participants to
                invest in tangible livestock.
              </p>
              ...
              <div className="space-y-6">
                <div className="bg-green-50 p-6 rounded-xl border-2 border-green-200">
                  ...
                  <p className="text-sm text-slate-700">
                    ...
                    purchase real-world livestock (Goat, Pig, Cow, or Carabao).
                  </p>
                </div>
                ...
                <div className="bg-blue-50 p-6 rounded-xl border-2 border-blue-200">
                  ...
                  <p className="text-sm text-slate-700">
                    Real-world farmers upload daily photos and health stats. To
                    maintain the digital twin's "Active" status, players must
                    acknowledge these reports, creating a direct connection
                    between the investor and the animal.
                  </p>
                </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border-l-4 border-purple-500">
                  ...
                  <p className="text-sm text-slate-600">
                    Finalization of Art, Community Building, and Smart Contract
                    audits on Sui.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border-l-4 border-green-500">
                  ...
                  <p className="text-sm text-slate-600">
                    Deployment of the Phygital Farming simulation and launch of
                    the Kapogian Farm NFT Collection.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-violet-50 p-6 rounded-xl border-l-4 border-indigo-500">
                  ...
                  <p className="text-sm text-slate-600">
                    Integration of trait-based MMR systems and expansion of the
                    livestock investment classes.
                  </p>
                </div>
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-slate-200 leading-relaxed">
                  Kapogian utilizes <strong>SUI's Object-Centric Model</strong>{" "}
                  to ensure assets are truly "living." Metadata—from an animal's
                  weight to a warrior's confidence—evolves in real-time.
                </p>
            ...
            >
              ...
              <div className="mt-12 bg-black/20 backdrop-blur-sm p-6 rounded-xl">
                <p className="text-xs text-white/80 max-w-2xl mx-auto leading-relaxed">
                  ...
                  digital assets designed for community engagement, gaming, and
                  brand participation. This project involves a long-term
