    ...
    <div className="flex flex-row justify-center items-end gap-2 md:gap-6 mb-12 w-full max-w-2xl mx-auto pt-4">
        ...
        {users[0] && (
          <>
            <div className="relative mb-3 transition-transform group-hover:scale-110 duration-300">
              <Image src={(users[0] as any).avatarImage} width={80} height={80} alt="Rank 2" className="w-16 h-16 md:w-20 md:h-20 rounded-full border-4 border-white bg-slate-200 object-cover shadow-md" />
      ...
      <div className="w-1/3 flex flex-col items-center animate-float-3 group cursor-pointer">
        {users[2] && (
          <>
            <div className="relative mb-3 transition-transform group-hover:scale-110 duration-300">
                <Image src={(users[2] as any).avatarImage} width={80} height={80} alt="Rank 3" className="w-16 h-16 md:w-20 md:h-20 rounded-full border-4 border-white bg-orange-100 object-cover shadow-md" />
  ...
  const ListItem = ({ user, delayIndex }: { user: MmrEntry | SummonEntry; delayIndex: number }) => (
    <div className="card-toy rounded-2xl md:rounded-3xl p-3 md:p-4 mb-3 flex items-center gap-3 md:gap-5 animate-pop-in cursor-default group transition-all" style={{ animationDelay: `${delayIndex * 50}ms`}}>
        ...
        <div className="relative">
            <Image src={user.avatarImage} width={48} height={48} alt="Avatar" className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-slate-100 border-2 border-white shadow-sm object-cover" />
        </div>
