...
export default function RoadmapV3Page() {
  ...
  useEffect(() => {
    ...
    const slides = Array.from(
      container.querySelectorAll(".slide-section"),
    ) as HTMLElement[];
    ...
    function updateTheme(slide: HTMLElement) {
      ...
      const xPos =
        activeIndex % 3 === 0 ? "10%" : activeIndex % 2 === 0 ? "80%" : "40%";
    ...
    <>
      ...
      <main>
        ...
        <div
          id="dynamic-bg"
          ref={bgLayerRef}
          className="fixed inset-0 z-0 bg-[#FFFDF5]"
        >
          ...
          <div
            id="ambient-orb"
            ref={ambientOrbRef}
            className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] rounded-full bg-white opacity-20 blur-[100px] transition-all duration-1000 transform translate-x-0"
          ></div>
        ...
        <div
          ...
          className="fixed top-0 left-0 h-full flex items-center will-change-transform pl-0"
        >
          {/* 0. INTRO */}
          <section
            className="slide-section w-screen h-screen flex-shrink-0 flex flex-col items-center justify-center relative px-6"
            data-theme="#FFFDF5"
            data-phase="START"
          >
            <div className="slide-content flex flex-col items-center text-center z-10 active-slide w-full max-w-4xl">
              <div className="mb-8 relative">
                ...
                <iconify-icon
                  ...
                  width="80"
                  class="text-slate-900 relative z-10 animate-float"
                ></iconify-icon>
              </div>
              <h1 className="text-6xl md:text-8xl font-semibold tracking-tighter-custom text-slate-900 leading-[0.9] mb-6">
                Kapogian
              </h1>
              ...
              <div className="pogi-card p-8 md:p-10 h-full flex flex-col relative group">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-center mb-6">
                    <span className="px-3 py-1 rounded-md bg-emerald-100 text-emerald-800 text-xs font-semibold tracking-wide">
                      Q1 2026
                    </span>
                    <iconify-icon
                  ...
                  <h2 className="text-4xl md:text-5xl font-semibold tracking-tighter-custom mb-2">
                    Genesis
                  </h2>
          ...
          >
            <div className="slide-content w-full h-full max-h-[640px]">
              <div className="pogi-card p-8 md:p-10 h-full flex flex-col relative group">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-center mb-6">
                    <span className="px-3 py-1 rounded-md bg-cyan-100 text-cyan-800 text-xs font-semibold tracking-wide">
                      Q1-Q2 2026
                    </span>
                    <iconify-icon
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs md:text-sm text-slate-500 leading-relaxed mt-1">
                          Verify NFT to order 1-to-1 unique apparel &amp;
                          plates.
                        </p>
                      </div>
                    </div>
          ...
          >
            <div className="slide-content w-full h-full max-h-[640px]">
              <div className="pogi-card p-8 md:p-10 h-full flex flex-col relative group">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-center mb-6">
                    <span className="px-3 py-1 rounded-md bg-purple-100 text-purple-800 text-xs font-semibold tracking-wide">
                      Q2-Q3 2026
                    </span>
                    <iconify-icon
          ...
          >
            <div className="slide-content w-full h-full max-h-[640px]">
              <div className="pogi-card p-8 md:p-10 h-full flex flex-col relative group">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-center mb-6">
                    <span className="px-3 py-1 rounded-md bg-orange-100 text-orange-800 text-xs font-semibold tracking-wide">
                      Q3-Q4 2026
                    </span>
                    <iconify-icon
          ...
          >
            <div className="slide-content w-full h-full max-h-[640px]">
              <div className="pogi-card p-8 md:p-10 h-full flex flex-col relative group">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-center mb-6">
                    <span className="px-3 py-1 rounded-md bg-yellow-100 text-yellow-800 text-xs font-semibold tracking-wide">
                      Q3 2027
                    </span>
                    <iconify-icon
            ...
            <div className="slide-content w-full h-full max-h-[640px]">
              <div className="pogi-card p-8 md:p-10 h-full flex flex-col relative border-pink-200 bg-gradient-to-b from-white to-pink-50">
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex justify-between items-center mb-6">
                    <span className="px-3 py-1 rounded-md bg-pink-100 text-pink-800 text-xs font-semibold tracking-wide">
                      End 2027
                    </span>
                    <iconify-icon
                  ...
                  <h2 className="text-5xl md:text-6xl font-semibold tracking-tighter-custom mb-2 text-pink-950">
                    $POGI
                  </h2>
          ...
          {/* 7. OUTRO */}
          <section
            className="slide-section w-screen h-screen flex-shrink-0 flex items-center justify-center relative px-6"
            data-theme="#1a1a1a"
            data-phase="END"
          >
            ...
            <div className="relative z-10 text-center text-white slide-content">
              <iconify-icon
                ...
                width="80"
                class="text-yellow-400 mb-6 animate-bounce"
              ></iconify-icon>
              <h2 className="text-6xl md:text-8xl font-semibold tracking-tighter-custom mb-6">
                Stay Pogi.
              </h2>
              <p className="text-slate-400 text-lg md:text-2xl mb-12 font-light">
                The Journey is Just Beginning.
              </p>
              <a
                href="https://discord.gg/XXnsqePq"
                className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black rounded-full text-lg font-semibold hover:scale-105 transition-transform"
              >
                Join the Community{" "}
...
```
This is a straightforward change. I will add the imports and then wrap the existing JSX in a fragment with the header and footer.Of course. I've added the main navigation header and the footer to your `roadmapv3` page.

<changes>
  <description>Added PageHeader and PageFooter to the roadmapv3 page.</description>
  <change>
    <file>/src/app/roadmapv3/page.tsx</file>
