      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 p-8 md:p-12 md:pr-0 flex flex-col justify-center relative z-10 pt-20">
          ...
          <div className={cn('flex gap-4 opacity-0', inView && 'animate-pop-in')} style={{ animationDelay: '0.5s' }}>
            <Link href="/generate">
              <Button
                className="bg-[hsl(var(--brand-yellow))] text-black comic-border rounded-xl px-6 py-3 font-headline text-xl toy-shadow flex items-center gap-2 h-auto hover-fill-button animate__animated animate__bounce animate__infinite"
              >
                <WandSparkles />
