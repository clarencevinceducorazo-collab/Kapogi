...
export interface EasterEggReveal {
  ...
  mmr: number;         // custom MMR — replaces calculated value
  rank: string;        // custom rank label — replaces Adept / Elite / Mythic
  lineage: string;     // custom lineage — replaces gender lineage display
}
